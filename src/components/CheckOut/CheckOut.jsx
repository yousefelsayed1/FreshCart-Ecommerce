...
export default function CheckOut() {
  ...
  let { checkOutPayment, setCartNumber, header, cartId } =
  ...
  let schemaValidation = Yup.object({
    details: Yup.string()
      ...
      .max(100, "max lenght is 100 Character")
      .required("Details is required"),
    phone: Yup.string()
      .required("Phone is required")
      .matches(/^01[0125][0-9]{8}$/, "Enter avalid phone number"),
    city: Yup.string()
      .min(3, "min length is 3")
      .max(15, "max lenght is 15 char")
  ...
  return (
    <div className="my-5 ">
      <Helmet>
        ...
        <meta
          name="description"
          content="Securely complete your purchase. Explore our payment options and finalize your order. Shop confidently!"
        />
        <title>Payment</title>
      </Helmet>
