    ...
    >
      ...
      <div className="row">
          ...
          <div className="row gy-4">
            <div className="col-md-12">
              ...
              <input
                ...
                id="name"
                name="email"
                className={`form-control mt-1 ${style.nameIcon} ${style.fs18} ${style.formBackground}`}
            ...
            <div className="col-md-12">
              ...
              <input
                ...
                id="email"
                name="email"
                className={`form-control mt-1 ${style.emailIcon} ${style.fs18} ${style.formBackground}`}
        ...
        <div className="col-md-12 text-center mt-2">
          <Link to="/forgetpassword" className="btn bg-main text-light w-50">
            Reset password
          </Link>
        </div>
      </div>
