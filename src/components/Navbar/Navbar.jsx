                ...
                <div className="d-flex justify-content-between align-items-center">
                  <li className="nav-item d-flex align-items-center me">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      <i className="fa-brands fa-instagram ms-2 me-3"></i>
                    </a>
                  </li>
                  <li className="nav-item position-relative ">
                    <NavLink className="nav-link" to="wishlist">
                      <i className="fa-regular fa-heart fs-5"></i>
                      <span className="position-absolute top-0 bg-main badge text-light">
                        {wishListNumber}
                      </span>
                    </NavLink>
                  </li>
                  ...
                  >
                    <Link className="nav-link loghover">
                      <div className="d-flex align-items-center">
                        Logout{" "}
                        <i
                          className={`fa-solid fa-arrow-right-from-bracket ${style.fs14} ms-2`}
                        ></i>
                      </div>
                    </Link>
                  </li>
