...
export default function Notfound() {
  ...
  return (
    <>
      ...
      <div
        className={`d-flex align-items-center justify-content-center ${style.my10}`}
        style={{
          display: "flex",
      ...
      <p className={`fw-bold text-muted fs-5 mb-3 text-center ${style.fsp7}`}>
        The page you were looking for could not be found.
      </p>
      <div className="d-flex justify-content-center my-3">
        <Link
          type="submit"
          className={`btn bg-main text-light fw-bolder mx-auto ${style.fsbtn}`}
        >
          Go To Home Page
        </Link>
      </div>
