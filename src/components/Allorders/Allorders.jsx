...
import style from "../../styles/Allorders.module.scss";
            ...
            <Table className="table mb-0 text-nowrap">
              ...
              {allOrders.length > 0 ? (
                allOrders?.map((order, indx) => {
                  return (
                    <Tbody className={`${style.fs9}`} key={indx}>
                      <Tr>
                            ...
                            return (
                              ...
                              >
                                <img
                                  ...
                                  alt="Ecommerce"
                                  key={product._id}
                                  className="icon-shape icon-xxl d-block mb-2 align-middle "
                                />
                                <p
                                  key={index}
                                  className=" text-wrap ms-4 align-middle fw-bold "
                                >
                        ...
                        <Td className="align-middle ">
                          <h6 className={` ${style.fs9} text-center`}>
                            {order.paymentMethodType}
                          </h6>
                        </Td>
                        <Td></Td>
                        <Td className="align-middle border-top-0 ">
                          <h6 className={`text-main ${style.fs9} text-center`}>
                            {order.totalOrderPrice}EGP
                          </h6>
                        </Td>
                        <Td className="align-middle ">
                          <p className="text-center">
                            This order is delivering to <br />
                            <span className="text-main">
                              {order.shippingAddress.city}
                            </span>
                            <br /> on phone number: <br />
                            <span className="text-main">
