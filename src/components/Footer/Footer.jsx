        ...
        <div className="container">
          ...
          <div className="row pb-2">
            ...
            <div className={`col-md-3 col-xlg-2 ${style.w75}`}>
              <button
                type="submit"
                className={`btn bg-main text-light fw-bolder w-100 ${style.fsbtn}`}
              >
                Share App Link
              </button>
            </div>
          ...
          <div
            className={`d-flex justify-content-between align-items-center flex-wrap py-3 ${style.borderTop}`}
          >
            <ul className=" list-unstyled d-flex text-lg-start text-center">
              <li className={`mt-1 ${style.fs8}`}>Payment Partners</li>
              <li>
                <img src={amazon} className="payment" alt="amazonpayment" />
              </li>
              <li>
                <img
                  src={american}
                  className="mt-1 mx-2"
                  alt="americanexpresspayment"
                />
              </li>
              <li>
                <img
                  src={masterCard}
                  className="mt-1 mx-2"
                  alt="masterCardpayment"
                />
              </li>
              <li>
                <img src={paypal} className="mt-1 mx-2" alt="paypalpayment" />
              </li>
              <li>
                <img src={visa} className="mt-1 mx-2" alt="visapayment" />
              </li>
            </ul>
