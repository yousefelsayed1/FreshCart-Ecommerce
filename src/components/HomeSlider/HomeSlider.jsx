...
import style from "../../styles/HomeSlider.module.scss";
    ...
    <div className={`row mt-5 ${style.mb8}`}>
          ...
          <div className="slider-container">
            <Slider {...settings}>
              <div className="rounded-3 position-relative">
                <img
                  src={imgSlider3}
                  className={`w-100 rounded-3 ${style.response}`}
                  height={525}
                  alt="imgSlider"
                />
                <div
                  style={{ fontFamily: '"Inter", sans-serif' }}
                  className={`col-xxl-7 col-lg-9 position-absolute top-0 start-0 ${style.py14} ${style.px8} ${style.psLg12} ${style.pyLg16}`}
                >
                  <div className="d-flex align-items-center mb-4">
                    <span>Exclusive Offer</span>
                    <span className="badge bg-danger ms-2">20%</span>
                  </div>
                  <h2 className={`text-dark fw-bold mb-3 ${style.display5}`}>
                    Cokoladni Kolutici Lasta
                  </h2>
                  <p className={`${style.fs5} text-dark`}>
                    Only on this week... Don’t miss
                  </p>
                  <div className="mb-4 mt-4">
                    <span className="text-dark">
                      Start from
                      <span className={`${style.fs4} text-danger ms-1`}>
                        185EGP
                      </span>
                    </span>
                  </div>
      ...
      <div className="col-xxl-4 col-xl-5 col-12 d-lg-flex d-xl-block gap-3 gap-xl-0">
        <div className={`position-relative w-100 ${style.mb6}`}>
          ...
          <div
            style={{ fontFamily: '"Inter", sans-serif' }}
            className={`position-absolute top-0 start-0 ${style.py9} ${style.px8}`}
          >
            <h3 className={`mb-0 fw-bold ${style.fs3}`}>
              10% cashback on
              <br />
              personal care
            </h3>
